				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="运动时长" prop="yundongshizhang">
							<el-input class="list_inp" v-model="form.yundongshizhang" placeholder="运动时长"
					...
					<el-col :span="12">
						<el-form-item label="运动目标" prop="yundongmubiao">
							<el-input class="list_inp" v-model="form.yundongmubiao" placeholder="运动目标"
								 type="text" 								:readonly="!isAdd||disabledForm.yundongmubiao?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			...
			yundongleixingLists.value = res.data.data
		})
	}
	//初始化
	//声明父级调用

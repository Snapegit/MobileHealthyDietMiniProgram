				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="睡眠时长" prop="shuimianshizhang">
							<el-input class="list_inp" v-model.number="form.shuimianshizhang" placeholder="睡眠时长"
								 type="text" 								:readonly="!isAdd||disabledForm.shuimianshizhang?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="睡眠质量" prop="shuimianzhiliang">
							<el-input class="list_inp" v-model="form.shuimianzhiliang" placeholder="睡眠质量"
								 type="text" 								:readonly="!isAdd||disabledForm.shuimianzhiliang?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="睡眠建议" prop="shuimianjianyi">
							<el-input v-model="form.shuimianjianyi" placeholder="睡眠建议" type="textarea"
							:readonly="!isAdd||disabledForm.shuimianjianyi?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	//基础信息
	const tableName = 'shuimianjianyi'
	const formName = '睡眠建议'
	//基础信息
	//form表单
	const form = ref({})
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shuimianjianyi'){
					form.value.shuimianjianyi = row[x];
					disabledForm.value.shuimianjianyi = true;
					continue;
				}

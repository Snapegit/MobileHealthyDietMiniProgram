		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="分析时间" prop="fenxishijian">
							<el-date-picker
								class="list_date"
								v-model="form.fenxishijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.fenxishijian?true:false"
								placeholder="请选择分析时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="分析简介" prop="fenxijianjie">
							<el-input v-model="form.fenxijianjie" placeholder="分析简介" type="textarea"
							:readonly="!isAdd||disabledForm.fenxijianjie?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="分析详情" prop="fenxixiangqing">
							<editor :value="form.fenxixiangqing" placeholder="请输入分析详情" :readonly="!isAdd||disabledForm.fenxixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'fenxixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fenxixiangqing = res.data.data.fenxixiangqing?(res.data.data.fenxixiangqing.replace(reg,'../../../cl34626181/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.fenxishijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fenxijianjie'){
					form.value.fenxijianjie = row[x];
					disabledForm.value.fenxijianjie = true;
					continue;
				}
				if(x=='fenxixiangqing'){
					form.value.fenxixiangqing = row[x];
					disabledForm.value.fenxixiangqing = true;
					continue;
				}
				if(x=='fenxishijian'){
					form.value.fenxishijian = row[x];
					disabledForm.value.fenxishijian = true;
					continue;
				}
			}
			if(row){

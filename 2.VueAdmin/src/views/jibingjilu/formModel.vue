		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="睡眠" prop="shuimian">
							<el-input class="list_inp" v-model="form.shuimian" placeholder="睡眠"
								 type="text" 								:readonly="!isAdd||disabledForm.shuimian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="食欲" prop="shiyu">
							<el-input class="list_inp" v-model="form.shiyu" placeholder="食欲"
								 type="text" 								:readonly="!isAdd||disabledForm.shiyu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="既往病史" prop="jiwangbingshi">
							<el-input v-model="form.jiwangbingshi" placeholder="既往病史" type="textarea"
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shuimian'){
					form.value.shuimian = row[x];
					disabledForm.value.shuimian = true;
					continue;
				}
				if(x=='shiyu'){
					form.value.shiyu = row[x];
					disabledForm.value.shiyu = true;
					continue;
				}
				if(x=='jiwangbingshi'){
		...
		context?.$http({
			...
			if(json.hasOwnProperty('shengao')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.shengao = json.shengao
				disabledForm.value.shengao = true;
			}
			if(json.hasOwnProperty('tizhong')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.tizhong = json.tizhong
				disabledForm.value.tizhong = true;
			}
		})
	}
